...
let articles = [
    {
        ...
        intro_text: "Her kan du finde alt om skat, og hvordan du skal forholde dig til det.",
        author: "SKAT",
    },
    {
        ...
        intro_text: "Du kommer ikke udenom skattefar – han står der hver måned og inddrager en del af din SU og din hårdt tjente løn. Så her er alt, du skal vide om frikort, bikort, hovedkort og forskudsopgørelse.",
        author: "Omnibus",
    ...
    },
    {
        ...
        intro_text: "Mange tror, at det udelukkende er loven, der bestemmer mindstelønnen, men det er ikke altid tilfældet. Reglerne for mindsteløn varierer alt afhængigt af, om du er omfattet af en overenskomst eller er privatansat, og om du er over eller under 18 år.",
        author: "Legal Desk",
    },
    {
        ...
        intro_text: "Fra og med det år, hvori du fylder 15 år, udskriver Skattestyrelsen automatisk en forskudsopgørelse med et frikort til dig. Du får ingen besked fra styrelsen om det, men hvis du logger dig ind på skat.dk, kan du se opgørelsen.",
        author: "BDO - Danmark",
    ...
    },
    {
        ...
        intro_text: "Skal træneren have løn eller skattefri godtgørelse? Dyk ned i reglerne her.",
        author: "DGI",
    },
];
export let amountToShow = 2;
export let amountOnScroll = 1;
</script>

<Carousel particlesToShow={amountToShow} particlesToScroll={amountOnScroll}>
    {#each articles as article}
        <article class="m-left">
            <header class="center">{article.title}</header>
            <!-- svelte-ignore a11y-img-redundant-alt -->
            <img src={article.imgURL} alt="article image" style="width:412px;height:275px;aspect-ratio:auto 412/275;" />
