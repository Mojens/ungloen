<script>
	...
	import PageNotFound from "./components/PageNotFound/PageNotFound.svelte";
...
<Router>
	...
	<Route path="*">
		<PageNotFound pageTitle="UngLøn | 404 - Siden findes ikke" />
	</Route>
	...
	<PrivateRoute
		...
		let:location
	>
		<Profile pageTitle="Profil | {$user.first_name + ' ' + $user.last_name}" />
	</PrivateRoute>
	...
	<PrivateRoute
		path="/tjenester/share-dollar/:teamId"
		let:location
	>
	...
	<PrivateRoute
		path="/accepter-invitation/:token/:teamId"
		let:location
	>
